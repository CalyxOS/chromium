...
public class AppRestrictionsProvider extends AbstractAppRestrictionsProvider {
    ...
    public static Bundle getApplicationRestrictionsFromUserManager(
        ...
        // https://chromeenterprise.google/policies/#FirstPartySetsEnabled
        restrictions.putBoolean("FirstPartySetsEnabled", false);
        // https://chromeenterprise.google/policies/#RelatedWebsiteSetsEnabled
        restrictions.putBoolean("RelatedWebsiteSetsEnabled", false);
        return restrictions;
    }
