...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e005891e1a2490882cc6d3f170fde22690efa53b',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@2551ff526e72894cede6e8bffd54578676f487a7',
    'condition': 'checkout_src_internal',
  },
