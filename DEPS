...
vars = {
  ...
  'skia_revision': 'c3c074db76330e847ab9adcaef66604b67c17745',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2a26215a720a2b741aa8868ae7a040f78d30f46c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '1c39f56e59167b9200d2a904e7e9a6a77a4dca4d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '6156c688716a5487e12d22d7412861e405480f01',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '3f3293981d5fd876f6d19e3de84b151e5041a8c2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@acb0ff31b9428d4f42e9527d6aac28dcfa8e0fce',
    'condition': 'checkout_src_internal',
  },
