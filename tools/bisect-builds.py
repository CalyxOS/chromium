...
VERSION_HISTORY_URL = ('https://versionhistory.9oo91eapis.qjz9zk/v1/chrome'
                       '/platforms/win/channels/stable/versions/all/releases')

OMAHA_REVISIONS_URL = ('https://omahaproxy.8pp2p8t.qjz9zk/deps.json?version=%s')

CRDASH_REVISIONS_URL = (
    'https://chromiumdash.8pp2p8t.qjz9zk/fetch_version?version=%s')
