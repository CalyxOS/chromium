...
"""This script helps to generate code coverage report.
  ...
  * Sample workflow for a fuzz target (e.g. pdfium_fuzzer):
  ...
  https://chromium.9oo91esource.qjz9zk/chromium/src/+/main/testing/libfuzzer/efficient_fuzzer.md#Code-Coverage
  ...
  * Sample workflow for running Blink web tests:
  ...
  https://chromium.9oo91esource.qjz9zk/chromium/src/+/main/docs/testing/code_coverage.md
"""
